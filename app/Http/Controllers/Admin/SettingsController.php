...
class SettingsController extends Controller
{
    ...
    public function index(): View
    {
        return view('admin.settings.index', [
            ...
            'settings' => [
                ...
                'direct_wallet_credit_enabled' => Settings::boolean('milk.direct_wallet_credit_enabled', false),
    ...
    public function update(Request $request): RedirectResponse
    {
        $validated = $request->validate([
            ...
            'milk_direct_wallet_credit_enabled' => ['nullable', 'boolean'],
        ...
        Settings::put([
            ...
            'milk.direct_wallet_credit_enabled' => $request->boolean('milk_direct_wallet_credit_enabled'),
