          ...
          <div class="modal-body">
            ...
            <div class="form-grid" style="grid-template-columns: 1fr 1fr; gap:12px;">
              ...
              <div class="field">
                ...
                <input type="text" id="ef-account-name" name="account_name" value="{{ old('account_name') }}" readonly placeholder="Auto-retrieved upon account entry" style="background:#f8fafc; font-weight:600; color:#0f172a; cursor:not-allowed;" />
